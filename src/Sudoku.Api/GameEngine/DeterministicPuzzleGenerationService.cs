...
public sealed class DeterministicPuzzleGenerationService : IPuzzleGenerationService
{
    ...
    {
        return Task.FromResult(new GeneratedPuzzle(difficulty, Puzzle, Solution));
    }
}
